...
pub struct AgentNode {
    ...
    /// Agent role spec — generated by PO Agent, resolved by kickoff into a full definition.
    /// If present, the kickoff flow uses the agent generator instead of loading from definition_path.
    #[serde(default)]
    pub spec: Option<AgentRoleSpec>,
}

/// Agent requirements as output by the PO Agent.
/// Describes what kind of agent is needed — resolved into a full AgentDefinition at kickoff.
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct AgentRoleSpec {
    /// Personality: developer, qa, reviewer, architect, designer, ux-researcher, devops
    pub personality: String,
    /// Capability bundles: code-writing, testing, rust, python, nodejs, frontend, browser-research, noether
    pub capabilities: Vec<String>,
    /// Model tier: balanced, strong, fast
        ...
        Dag {
            ...
            agents: vec![
                AgentNode {
                    ...
                    definition_path: "agents/backend-developer.yaml".into(), spec: None,
                },
                AgentNode {
                    id: "qa-1".into(),
                    role: "qa-engineer".into(),
                    definition_path: "agents/qa-engineer.yaml".into(), spec: None,
                },
                AgentNode {
                    id: "reviewer-1".into(),
                    role: "senior-reviewer".into(),
                    definition_path: "agents/senior-reviewer.yaml".into(), spec: None,
                },
            ],
            tasks: vec![
                Task {
